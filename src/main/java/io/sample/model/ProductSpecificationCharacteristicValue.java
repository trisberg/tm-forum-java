...
public class ProductSpecificationCharacteristicValue   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseType, schemaLocation, type, isDefault, rangeInterval, regex, unitOfMeasure, validFor, value, valueFrom, valueTo, valueType);
  }
