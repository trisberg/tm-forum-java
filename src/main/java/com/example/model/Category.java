...
public class Category   {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseType, schemaLocation, type, description, href, id, isRoot, lastUpdate, lifecycleStatus, name, parentId, productOffering, subCategory, validFor, version);
  }
