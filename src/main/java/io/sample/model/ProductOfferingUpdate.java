...
import io.sample.model.AgreementRef;
import io.sample.model.AttachmentRefOrValue;
import io.sample.model.BundledProductOffering;
import io.sample.model.CategoryRef;
import io.sample.model.ChannelRef;
import io.sample.model.MarketSegmentRef;
import io.sample.model.PlaceRef;
import io.sample.model.ProductOfferingPriceRef;
...
import io.sample.model.ResourceCandidateRef;
import io.sample.model.SLARef;
import io.sample.model.ServiceCandidateRef;
...
public class ProductOfferingUpdate   {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.baseType, productOfferingUpdate.baseType) &&
        ...
        Objects.equals(this.description, productOfferingUpdate.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(baseType, schemaLocation, type, agreement, attachment, bundledProductOffering, category, channel, description, isBundle, isSellable, lifecycleStatus, marketSegment, name, place, prodSpecCharValueUse, productOfferingPrice, productOfferingTerm, productSpecification, resourceCandidate, serviceCandidate, serviceLevelAgreement, statusReason, validFor, version);
  }
